      ...
      {projectQuery.data?.length === 0 ? (
        ...
        projectQuery.data!.map((project, index) => (
          <Link
            ...
            key={index}
          >
            <TouchableOpacity className="bg-light-surface dark:bg-dark-surface p-5 rounded-3xl mb-4 shadow-sm border border-transparent dark:border-dark-border">
              ...
              <View className="mb-4">
                <View
                  className="w-full bg-light-background dark:bg-dark-background rounded-full overflow-hidden"
                  style={{ height: 8 }}
                >
                  <View
